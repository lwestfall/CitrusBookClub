...
export function getBookRatings(http: HttpClient, rootUrl: string, params: GetBookRatings$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<RatingDto>>> {
